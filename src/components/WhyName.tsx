        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight">
              One machine.
              <br />
              <span className="gradient-text">Two engines.</span>
              <br />
          ...
          >
            <p className="text-[#e8f4f8]/82 leading-relaxed">
              We don&apos;t sell you everything upfront. We diagnose where your business is
              and what it actually needs — then build exactly that. Some clients start with
              Core. Some need both. A healthy, growing business runs both engines together.
            </p>

            <div className="glass-card p-5">
              <p className="text-sm text-[#e8f4f8]/75 leading-relaxed">
                Already running ads or SEO? Without a real follow-up system behind them,
                you&apos;re funding a leaky bucket. We fix the leak first — then help you
